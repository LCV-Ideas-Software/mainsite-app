...
Latest supported release: v03.23.05, covering mainsite-frontend v03.23.05 and mainsite-worker v02.20.01. The current main branch is also supported for security fixes until the next release is published.
